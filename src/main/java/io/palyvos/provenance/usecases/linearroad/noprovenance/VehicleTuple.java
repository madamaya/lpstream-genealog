...
public class VehicleTuple extends BaseTuple {
	...
	public VehicleTuple(long timestamp, int vid, int reports, int xway, int lane,
			int dir, int seg, int pos, boolean uniquePosition, long dominantOpTime, long kafkaAppendTime, long stimulus) {
	  super(timestamp, xway + "," + lane + "," + dir + "," + seg + "," + pos, dominantOpTime, kafkaAppendTime, stimulus);
		this.vid = vid;
