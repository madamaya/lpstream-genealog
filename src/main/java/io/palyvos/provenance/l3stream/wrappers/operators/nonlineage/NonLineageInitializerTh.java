...
public class NonLineageInitializerTh extends RichMapFunction<ObjectNode, L3StreamTupleContainer<ObjectNode>> {
  ...
  public <F extends Function<ObjectNode, Long> & Serializable> NonLineageInitializerTh(F timestampFunction,
                                                                                       F stimulusFunction,
                                                                                       ExperimentSettings settings,
                                                                                       String flag) {
  ...
  public void close() throws Exception {
    ...
    PrintWriter pw = new PrintWriter(System.getenv("HOME") + "/logs/" + flag + "nonlineage/throughput" + getRuntimeContext().getIndexOfThisSubtask() + "_" + end + "_-short_-1_0_1000.log.log");
