...
public class LineageRichFilterFunction<T> extends RichFilterFunction<L3StreamTupleContainer<T>> {

  private final RichFilterFunction<T> delegate;

  public LineageRichFilterFunction(RichFilterFunction<T> delegate) {
