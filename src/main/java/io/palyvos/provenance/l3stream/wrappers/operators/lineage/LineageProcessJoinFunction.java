...
public class LineageProcessJoinFunction<IN1, IN2, OUT> extends
  ...
  public LineageProcessJoinFunction(
  ...
  private static class CollectorAdapter<T1, T2, O> implements Collector<O> {
    ...
    public void collect(O record) {
      ...
      genealogResult.setLineageReliable(left.getLineageReliable() && right.getLineageReliable());
